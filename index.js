...
DevelopersIO、Zennなどで100本以上の技術記事を執筆すると共に、技術雑誌への寄稿実績もあり、AWSや生成AIを中心とした最新技術を発信しています。
...
**概要**：生成AIを活用した自社SaaSチャットボットアプリをフルスクラッチで開発
...
**概要**：生成 AI 関連の案件に対応する体制作りのため、生成 AI に特化したインフラを専門に部署を跨いだ交流を促進する活動を実施

**役割**：チームリーダー/生成AIエンジニア
...
**概要**：生成 AI を活用したチャットボットアプリで使用する、社内ドキュメントを検索するための RAG システムを構築
...
**概要**：複数の AWS アカウントに対する通知設定を一括で付与できる、通知集約システムを開発
...
**概要**：SaaS から出力されるログを定期的に AWS にアップロードし、特定用途で使用するためのログ形式に加工するサーバレスアプリ及びCICDシステムをフルスクラッチで開発
...
1. 技術営業/顧客折衝/チームマネジメント(3 人)
2. サーバレスアプリ/CICD システム設計
3. サーバレスアプリ/CICD システム構築
...
**概要**：顧客情報利用のための認証システムにおいて稼働が必要な、アプリケーションのコンテナ化に伴う技術支援を実施。  

**役割**：プロジェクトマネージャー/インフラエンジニア

**業務内容**

1. 顧客折衝/チームマネジメント(5 人)
2. コンテナインフラ/CICD システム設計
3. コンテナインフラ/CICD システム構築
...
1. 技術営業/顧客折衝
2. マルチアカウント基盤設計に必要な技術質問対応
3. マルチアカウント基盤構築に必要な動作検証
...
**概要**：新規 EC サイトにおけるランディングページに必要な静的ウェブサイトホスティング基盤を構築。

**役割**：プロジェクトマネージャー/インフラエンジニア

**業務内容**

1. チームマネジメント(3 人)/顧客折衝
2. 静的ウェブサイトホスティングインフラ設計書作成
3. 静的ウェブサイトホスティングインフラ構築
...
**概要**：動画サイト構築 CMS 新規導入のためのウェブサイト基盤を構築。
...
**概要**：AWSを基盤とするWebアプリケーションの設計/開発を行う自社開発企業にて、アーキテクチャの相談役として参画
