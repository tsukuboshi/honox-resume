var Er=Object.defineProperty;var Zt=e=>{throw TypeError(e)};var kr=(e,t,n)=>t in e?Er(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var w=(e,t,n)=>kr(e,typeof t!="symbol"?t+"":t,n),vt=(e,t,n)=>t.has(e)||Zt("Cannot "+n);var c=(e,t,n)=>(vt(e,t,"read from private field"),n?n.call(e):t.get(e)),x=(e,t,n)=>t.has(e)?Zt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,n),b=(e,t,n,r)=>(vt(e,t,"write to private field"),r?r.call(e,n):t.set(e,n),n),k=(e,t,n)=>(vt(e,t,"access private method"),n);var Xt=(e,t,n,r)=>({set _(s){b(e,t,s,n)},get _(){return c(e,t,r)}});import{AsyncLocalStorage as Rr}from"node:async_hooks";function Or(){const{process:e,Deno:t}=globalThis;return!(typeof(t==null?void 0:t.noColor)=="boolean"?t.noColor:e!==void 0?"NO_COLOR"in(e==null?void 0:e.env):!1)}var jt="__COMPOSED_HANDLER",Pn=e=>e.length>1,In=e=>e[jt]?In(e[jt]):e,Pr=e=>e.name||(Pn(e)?"[middleware]":"[handler]"),Ir=e=>e.routes.map(({path:t,method:n,handler:r})=>{const s=In(r);return{path:t,method:n,name:Pr(s),isMiddleware:Pn(s)}}),jr=(e,t)=>{const n=Or(),r={};let s=0,o=0;Ir(e).filter(({isMiddleware:a})=>!a).map(a=>{const i=`${a.method}-${a.path}`;if((r[i]||(r[i]=[])).push(a),!(r[i].length>1))return s=Math.max(s,a.method.length),o=Math.max(o,a.path.length),{method:a.method,path:a.path,routes:r[i]}}).forEach(a=>{if(!a)return;const{method:i,path:l,routes:u}=a,d=n?`\x1B[32m${i}\x1B[0m`:i;console.log(`${d} ${" ".repeat(s-i.length)} ${l}`)})};const Dr=e=>(e.status(404),e.render("404 Not Found")),Lr=Object.freeze(Object.defineProperty({__proto__:null,default:Dr},Symbol.toStringTag,{value:"Module"})),Nr=(e,t)=>"getResponse"in e?e.getResponse():(console.error(e.message),t.status(500),t.render("Internal Server Error")),Tr=Object.freeze(Object.defineProperty({__proto__:null,default:Nr},Symbol.toStringTag,{value:"Module"}));var jn={Stringify:1},F=(e,t)=>{const n=new String(e);return n.isEscaped=!0,n.callbacks=t,n},_r=/[&<>'"]/,Dn=async(e,t)=>{let n="";t||(t=[]);const r=await Promise.all(e);for(let s=r.length-1;n+=r[s],s--,!(s<0);s--){let o=r[s];typeof o=="object"&&t.push(...o.callbacks||[]);const a=o.isEscaped;if(o=await(typeof o=="object"?o.toString():o),typeof o=="object"&&t.push(...o.callbacks||[]),o.isEscaped??a)n+=o;else{const i=[n];ue(o,i),n=i[0]}}return F(n,t)},ue=(e,t)=>{const n=e.search(_r);if(n===-1){t[0]+=e;return}let r,s,o=0;for(s=n;s<e.length;s++){switch(e.charCodeAt(s)){case 34:r="&quot;";break;case 39:r="&#39;";break;case 38:r="&amp;";break;case 60:r="&lt;";break;case 62:r="&gt;";break;default:continue}t[0]+=e.substring(o,s)+r,o=s+1}t[0]+=e.substring(o,s)},Ln=e=>{const t=e.callbacks;if(!(t!=null&&t.length))return e;const n=[e],r={};return t.forEach(s=>s({phase:jn.Stringify,buffer:n,context:r})),n[0]},Nn=async(e,t,n,r,s)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const o=e.callbacks;return o!=null&&o.length?(s?s[0]+=e:s=[e],Promise.all(o.map(i=>i({phase:t,buffer:s,context:r}))).then(i=>Promise.all(i.filter(Boolean).map(l=>Nn(l,t,!1,r,s))).then(()=>s[0]))):Promise.resolve(e)},$r=(e,...t)=>{const n=[""];for(let r=0,s=e.length-1;r<s;r++){n[0]+=e[r];const o=Array.isArray(t[r])?t[r].flat(1/0):[t[r]];for(let a=0,i=o.length;a<i;a++){const l=o[a];if(typeof l=="string")ue(l,n);else if(typeof l=="number")n[0]+=l;else{if(typeof l=="boolean"||l===null||l===void 0)continue;if(typeof l=="object"&&l.isEscaped)if(l.callbacks)n.unshift("",l);else{const u=l.toString();u instanceof Promise?n.unshift("",u):n[0]+=u}else l instanceof Promise?n.unshift("",l):ue(l.toString(),n)}}}return n[0]+=e.at(-1),n.length===1?"callbacks"in n?F(Ln(F(n[0],n.callbacks))):F(n[0]):Dn(n,n.callbacks)},Bt=Symbol("RENDERER"),Dt=Symbol("ERROR_HANDLER"),O=Symbol("STASH"),Tn=Symbol("INTERNAL"),Mr=Symbol("MEMO"),ft=Symbol("PERMALINK"),Yt=e=>(e[Tn]=!0,e),_n=e=>({value:t,children:n})=>{if(!n)return;const r={children:[{tag:Yt(()=>{e.push(t)}),props:{}}]};Array.isArray(n)?r.children.push(...n.flat()):r.children.push(n),r.children.push({tag:Yt(()=>{e.pop()}),props:{}});const s={tag:"",props:r,type:""};return s[Dt]=o=>{throw e.pop(),o},s},$n=e=>{const t=[e],n=_n(t);return n.values=t,n.Provider=n,Ie.push(n),n},Ie=[],Gt=e=>{const t=[e],n=r=>{t.push(r.value);let s;try{s=r.children?(Array.isArray(r.children)?new Fn("",{},r.children):r.children).toString():""}finally{t.pop()}return s instanceof Promise?s.then(o=>F(o,o.callbacks)):F(s)};return n.values=t,n.Provider=n,n[Bt]=_n(t),Ie.push(n),n},Ae=e=>e.values.at(-1),st={title:[],script:["src"],style:["data-href"],link:["href"],meta:["name","httpEquiv","charset","itemProp"]},Lt={},ot="data-precedence",Ye=e=>Array.isArray(e)?e:[e],Qt=new WeakMap,en=(e,t,n,r)=>({buffer:s,context:o})=>{if(!s)return;const a=Qt.get(o)||{};Qt.set(o,a);const i=a[e]||(a[e]=[]);let l=!1;const u=st[e];if(u.length>0){e:for(const[,d]of i)for(const h of u)if(((d==null?void 0:d[h])??null)===(n==null?void 0:n[h])){l=!0;break e}}if(l?s[0]=s[0].replaceAll(t,""):u.length>0?i.push([t,n,r]):i.unshift([t,n,r]),s[0].indexOf("</head>")!==-1){let d;if(r===void 0)d=i.map(([h])=>h);else{const h=[];d=i.map(([f,,g])=>{let v=h.indexOf(g);return v===-1&&(h.push(g),v=h.length-1),[f,v]}).sort((f,g)=>f[1]-g[1]).map(([f])=>f)}d.forEach(h=>{s[0]=s[0].replaceAll(h,"")}),s[0]=s[0].replace(/(?=<\/head>)/,d.join(""))}},Qe=(e,t,n)=>F(new K(e,n,Ye(t??[])).toString()),et=(e,t,n,r)=>{if("itemProp"in n)return Qe(e,t,n);let{precedence:s,blocking:o,...a}=n;s=r?s??"":void 0,r&&(a[ot]=s);const i=new K(e,a,Ye(t||[])).toString();return i instanceof Promise?i.then(l=>F(i,[...l.callbacks||[],en(e,l,a,s)])):F(i,[en(e,i,a,s)])},Wr=({children:e,...t})=>{const n=zt();if(n){const r=Ae(n);if(r==="svg"||r==="head")return new K("title",t,Ye(e??[]))}return et("title",e,t,!1)},Hr=({children:e,...t})=>{const n=zt();return["src","async"].some(r=>!t[r])||n&&Ae(n)==="head"?Qe("script",e,t):et("script",e,t,!1)},Fr=({children:e,...t})=>["href","precedence"].every(n=>n in t)?(t["data-href"]=t.href,delete t.href,et("style",e,t,!0)):Qe("style",e,t),Br=({children:e,...t})=>["onLoad","onError"].some(n=>n in t)||t.rel==="stylesheet"&&(!("precedence"in t)||"disabled"in t)?Qe("link",e,t):et("link",e,t,"precedence"in t),Gr=({children:e,...t})=>{const n=zt();return n&&Ae(n)==="head"?Qe("meta",e,t):et("meta",e,t,!1)},Mn=(e,{children:t,...n})=>new K(e,n,Ye(t??[])),zr=e=>(typeof e.action=="function"&&(e.action=ft in e.action?e.action[ft]:void 0),Mn("form",e)),Wn=(e,t)=>(typeof t.formAction=="function"&&(t.formAction=ft in t.formAction?t.formAction[ft]:void 0),Mn(e,t)),Ur=e=>Wn("input",e),Kr=e=>Wn("button",e);const yt=Object.freeze(Object.defineProperty({__proto__:null,button:Kr,form:zr,input:Ur,link:Br,meta:Gr,script:Hr,style:Fr,title:Wr},Symbol.toStringTag,{value:"Module"}));var qr=new Map([["className","class"],["htmlFor","for"],["crossOrigin","crossorigin"],["httpEquiv","http-equiv"],["itemProp","itemprop"],["fetchPriority","fetchpriority"],["noModule","nomodule"],["formAction","formaction"]]),pt=e=>qr.get(e)||e,Hn=(e,t)=>{for(const[n,r]of Object.entries(e)){const s=n[0]==="-"||!/[A-Z]/.test(n)?n:n.replace(/[A-Z]/g,o=>`-${o.toLowerCase()}`);t(s,r==null?null:typeof r=="number"?s.match(/^(?:a|border-im|column(?:-c|s)|flex(?:$|-[^b])|grid-(?:ar|[^a])|font-w|li|or|sca|st|ta|wido|z)|ty$/)?`${r}`:`${r}px`:r)}},Ge=void 0,zt=()=>Ge,Vr=e=>/[A-Z]/.test(e)&&e.match(/^(?:al|basel|clip(?:Path|Rule)$|co|do|fill|fl|fo|gl|let|lig|i|marker[EMS]|o|pai|pointe|sh|st[or]|text[^L]|tr|u|ve|w)/)?e.replace(/([A-Z])/g,"-$1").toLowerCase():e,Jr=["area","base","br","col","embed","hr","img","input","keygen","link","meta","param","source","track","wbr"],Zr=["allowfullscreen","async","autofocus","autoplay","checked","controls","default","defer","disabled","download","formnovalidate","hidden","inert","ismap","itemscope","loop","multiple","muted","nomodule","novalidate","open","playsinline","readonly","required","reversed","selected"],Ut=(e,t)=>{for(let n=0,r=e.length;n<r;n++){const s=e[n];if(typeof s=="string")ue(s,t);else{if(typeof s=="boolean"||s===null||s===void 0)continue;s instanceof K?s.toStringToBuffer(t):typeof s=="number"||s.isEscaped?t[0]+=s:s instanceof Promise?t.unshift("",s):Ut(s,t)}}},K=class{constructor(e,t,n){w(this,"tag");w(this,"props");w(this,"key");w(this,"children");w(this,"isEscaped",!0);w(this,"localContexts");this.tag=e,this.props=t,this.children=n}get type(){return this.tag}get ref(){return this.props.ref||null}toString(){var t,n;const e=[""];(t=this.localContexts)==null||t.forEach(([r,s])=>{r.values.push(s)});try{this.toStringToBuffer(e)}finally{(n=this.localContexts)==null||n.forEach(([r])=>{r.values.pop()})}return e.length===1?"callbacks"in e?Ln(F(e[0],e.callbacks)).toString():e[0]:Dn(e,e.callbacks)}toStringToBuffer(e){const t=this.tag,n=this.props;let{children:r}=this;e[0]+=`<${t}`;const s=Ge&&Ae(Ge)==="svg"?o=>Vr(pt(o)):o=>pt(o);for(let[o,a]of Object.entries(n))if(o=s(o),o!=="children"){if(o==="style"&&typeof a=="object"){let i="";Hn(a,(l,u)=>{u!=null&&(i+=`${i?";":""}${l}:${u}`)}),e[0]+=' style="',ue(i,e),e[0]+='"'}else if(typeof a=="string")e[0]+=` ${o}="`,ue(a,e),e[0]+='"';else if(a!=null)if(typeof a=="number"||a.isEscaped)e[0]+=` ${o}="${a}"`;else if(typeof a=="boolean"&&Zr.includes(o))a&&(e[0]+=` ${o}=""`);else if(o==="dangerouslySetInnerHTML"){if(r.length>0)throw"Can only set one of `children` or `props.dangerouslySetInnerHTML`.";r=[F(a.__html)]}else if(a instanceof Promise)e[0]+=` ${o}="`,e.unshift('"',a);else if(typeof a=="function"){if(!o.startsWith("on"))throw`Invalid prop '${o}' of type 'function' supplied to '${t}'.`}else e[0]+=` ${o}="`,ue(a.toString(),e),e[0]+='"'}if(Jr.includes(t)&&r.length===0){e[0]+="/>";return}e[0]+=">",Ut(r,e),e[0]+=`</${t}>`}},St=class extends K{toStringToBuffer(e){const{children:t}=this,n=this.tag.call(null,{...this.props,children:t.length<=1?t[0]:t});if(!(typeof n=="boolean"||n==null))if(n instanceof Promise)if(Ie.length===0)e.unshift("",n);else{const r=Ie.map(s=>[s,s.values.at(-1)]);e.unshift("",n.then(s=>(s instanceof K&&(s.localContexts=r),s)))}else n instanceof K?n.toStringToBuffer(e):typeof n=="number"||n.isEscaped?(e[0]+=n,n.callbacks&&(e.callbacks||(e.callbacks=[]),e.callbacks.push(...n.callbacks))):ue(n,e)}},Fn=class extends K{toStringToBuffer(e){Ut(this.children,e)}},Nt=(e,t,...n)=>{t??(t={}),n.length&&(t.children=n.length===1?n[0]:n);const r=t.key;delete t.key;const s=at(e,t,n);return s.key=r,s},tn=!1,at=(e,t,n)=>{if(!tn){for(const r in Lt)yt[r][Bt]=Lt[r];tn=!0}return typeof e=="function"?new St(e,t,n):yt[e]?new St(yt[e],t,n):e==="svg"||e==="head"?(Ge||(Ge=Gt("")),new K(e,t,[new St(Ge,{value:e},n)])):new K(e,t,n)},je=({children:e})=>new Fn("",{children:e},Array.isArray(e)?e:e?[e]:[]),Xr=e=>!!(e&&typeof e=="object"&&"tag"in e&&"props"in e);function p(e,t,n){let r;if(!t||!("children"in t))r=at(e,t,[]);else{const s=t.children;r=Array.isArray(s)?at(e,t,s):at(e,t,[s])}return r.key=n,r}var ze="_hp",Yr={Change:"Input",DoubleClick:"DblClick"},Qr={svg:"2000/svg",math:"1998/Math/MathML"},De=[],Tt=new WeakMap,Le=void 0,es=()=>Le,Z=e=>"t"in e,wt={onClick:["click",!1]},nn=e=>{if(!e.startsWith("on"))return;if(wt[e])return wt[e];const t=e.match(/^on([A-Z][a-zA-Z]+?(?:PointerCapture)?)(Capture)?$/);if(t){const[,n,r]=t;return wt[e]=[(Yr[n]||n).toLowerCase(),!!r]}},rn=(e,t)=>Le&&e instanceof SVGElement&&/[A-Z]/.test(t)&&(t in e.style||t.match(/^(?:o|pai|str|u|ve)/))?t.replace(/([A-Z])/g,"-$1").toLowerCase():t,ts=(e,t,n)=>{var r;t||(t={});for(let s in t){const o=t[s];if(s!=="children"&&(!n||n[s]!==o)){s=pt(s);const a=nn(s);if(a){if((n==null?void 0:n[s])!==o&&(n&&e.removeEventListener(a[0],n[s],a[1]),o!=null)){if(typeof o!="function")throw new Error(`Event handler for "${s}" is not a function`);e.addEventListener(a[0],o,a[1])}}else if(s==="dangerouslySetInnerHTML"&&o)e.innerHTML=o.__html;else if(s==="ref"){let i;typeof o=="function"?i=o(e)||(()=>o(null)):o&&"current"in o&&(o.current=e,i=()=>o.current=null),Tt.set(e,i)}else if(s==="style"){const i=e.style;typeof o=="string"?i.cssText=o:(i.cssText="",o!=null&&Hn(o,i.setProperty.bind(i)))}else{if(s==="value"){const l=e.nodeName;if(l==="INPUT"||l==="TEXTAREA"||l==="SELECT"){if(e.value=o==null||o===!1?null:o,l==="TEXTAREA"){e.textContent=o;continue}else if(l==="SELECT"){e.selectedIndex===-1&&(e.selectedIndex=0);continue}}}else(s==="checked"&&e.nodeName==="INPUT"||s==="selected"&&e.nodeName==="OPTION")&&(e[s]=o);const i=rn(e,s);o==null||o===!1?e.removeAttribute(i):o===!0?e.setAttribute(i,""):typeof o=="string"||typeof o=="number"?e.setAttribute(i,o):e.setAttribute(i,o.toString())}}}if(n)for(let s in n){const o=n[s];if(s!=="children"&&!(s in t)){s=pt(s);const a=nn(s);a?e.removeEventListener(a[0],o,a[1]):s==="ref"?(r=Tt.get(e))==null||r():e.removeAttribute(rn(e,s))}}},ns=(e,t)=>{t[O][0]=0,De.push([e,t]);const n=t.tag[Bt]||t.tag,r=n.defaultProps?{...n.defaultProps,...t.props}:t.props;try{return[n.call(null,r)]}finally{De.pop()}},Bn=(e,t,n,r,s)=>{var o,a;(o=e.vR)!=null&&o.length&&(r.push(...e.vR),delete e.vR),typeof e.tag=="function"&&((a=e[O][1][He])==null||a.forEach(i=>s.push(i))),e.vC.forEach(i=>{var l;if(Z(i))n.push(i);else if(typeof i.tag=="function"||i.tag===""){i.c=t;const u=n.length;if(Bn(i,t,n,r,s),i.s){for(let d=u;d<n.length;d++)n[d].s=!0;i.s=!1}}else n.push(i),(l=i.vR)!=null&&l.length&&(r.push(...i.vR),delete i.vR)})},rs=e=>{for(;;e=e.tag===ze||!e.vC||!e.pP?e.nN:e.vC[0]){if(!e)return null;if(e.tag!==ze&&e.e)return e.e}},Gn=e=>{var t,n,r,s,o,a;Z(e)||((n=(t=e[O])==null?void 0:t[1][He])==null||n.forEach(i=>{var l;return(l=i[2])==null?void 0:l.call(i)}),(r=Tt.get(e.e))==null||r(),e.p===2&&((s=e.vC)==null||s.forEach(i=>i.p=2)),(o=e.vC)==null||o.forEach(Gn)),e.p||((a=e.e)==null||a.remove(),delete e.e),typeof e.tag=="function"&&($e.delete(e),it.delete(e),delete e[O][3],e.a=!0)},zn=(e,t,n)=>{e.c=t,Un(e,t,n)},sn=(e,t)=>{if(t){for(let n=0,r=e.length;n<r;n++)if(e[n]===t)return n}},on=Symbol(),Un=(e,t,n)=>{var u;const r=[],s=[],o=[];Bn(e,t,r,s,o),s.forEach(Gn);const a=n?void 0:t.childNodes;let i,l=null;if(n)i=-1;else if(!a.length)i=0;else{const d=sn(a,rs(e.nN));d!==void 0?(l=a[d],i=d):i=sn(a,(u=r.find(h=>h.tag!==ze&&h.e))==null?void 0:u.e)??-1,i===-1&&(n=!0)}for(let d=0,h=r.length;d<h;d++,i++){const f=r[d];let g;if(f.s&&f.e)g=f.e,f.s=!1;else{const v=n||!f.e;Z(f)?(f.e&&f.d&&(f.e.textContent=f.t),f.d=!1,g=f.e||(f.e=document.createTextNode(f.t))):(g=f.e||(f.e=f.n?document.createElementNS(f.n,f.tag):document.createElement(f.tag)),ts(g,f.props,f.pP),Un(f,g,v))}f.tag===ze?i--:n?g.parentNode||t.appendChild(g):a[i]!==g&&a[i-1]!==g&&(a[i+1]===g?t.appendChild(a[i]):t.insertBefore(g,l||a[i]||null))}if(e.pP&&delete e.pP,o.length){const d=[],h=[];o.forEach(([,f,,g,v])=>{f&&d.push(f),g&&h.push(g),v==null||v()}),d.forEach(f=>f()),h.length&&requestAnimationFrame(()=>{h.forEach(f=>f())})}},ss=(e,t)=>!!(e&&e.length===t.length&&e.every((n,r)=>n[1]===t[r][1])),it=new WeakMap,_t=(e,t,n)=>{var o,a,i,l,u,d;const r=!n&&t.pC;n&&(t.pC||(t.pC=t.vC));let s;try{n||(n=typeof t.tag=="function"?ns(e,t):Ye(t.props.children)),((o=n[0])==null?void 0:o.tag)===""&&n[0][Dt]&&(s=n[0][Dt],e[5].push([e,s,t]));const h=r?[...t.pC]:t.vC?[...t.vC]:void 0,f=[];let g;for(let v=0;v<n.length;v++){Array.isArray(n[v])&&n.splice(v,1,...n[v].flat());let m=os(n[v]);if(m){typeof m.tag=="function"&&!m.tag[Tn]&&(Ie.length>0&&(m[O][2]=Ie.map(S=>[S,S.values.at(-1)])),(a=e[5])!=null&&a.length&&(m[O][3]=e[5].at(-1)));let y;if(h&&h.length){const S=h.findIndex(Z(m)?A=>Z(A):m.key!==void 0?A=>A.key===m.key&&A.tag===m.tag:A=>A.tag===m.tag);S!==-1&&(y=h[S],h.splice(S,1))}if(y)if(Z(m))y.t!==m.t&&(y.t=m.t,y.d=!0),m=y;else{const S=y.pP=y.props;if(y.props=m.props,y.f||(y.f=m.f||t.f),typeof m.tag=="function"){const A=y[O][2];y[O][2]=m[O][2]||[],y[O][3]=m[O][3],!y.f&&((y.o||y)===m.o||(l=(i=y.tag)[Mr])!=null&&l.call(i,S,y.props))&&ss(A,y[O][2])&&(y.s=!0)}m=y}else if(!Z(m)&&Le){const S=Ae(Le);S&&(m.n=S)}if(!Z(m)&&!m.s&&(_t(e,m),delete m.f),f.push(m),g&&!g.s&&!m.s)for(let S=g;S&&!Z(S);S=(u=S.vC)==null?void 0:u.at(-1))S.nN=m;g=m}}t.vR=r?[...t.vC,...h||[]]:h||[],t.vC=f,r&&delete t.pC}catch(h){if(t.f=!0,h===on){if(s)return;throw h}const[f,g,v]=((d=t[O])==null?void 0:d[3])||[];if(g){const m=()=>lt([0,!1,e[2]],v),y=it.get(v)||[];y.push(m),it.set(v,y);const S=g(h,()=>{const A=it.get(v);if(A){const C=A.indexOf(m);if(C!==-1)return A.splice(C,1),m()}});if(S){if(e[0]===1)e[1]=!0;else if(_t(e,v,[S]),(g.length===1||e!==f)&&v.c){zn(v,v.c,!1);return}throw on}}throw h}finally{s&&e[5].pop()}},os=e=>{if(!(e==null||typeof e=="boolean")){if(typeof e=="string"||typeof e=="number")return{t:e.toString(),d:!0};if("vR"in e&&(e={tag:e.tag,props:e.props,key:e.key,f:e.f,type:e.tag,ref:e.props.ref,o:e.o||e}),typeof e.tag=="function")e[O]=[0,[]];else{const t=Qr[e.tag];t&&(Le||(Le=$n("")),e.props.children=[{tag:Le,props:{value:e.n=`http://www.w3.org/${t}`,children:e.props.children}}])}return e}},an=(e,t)=>{var n,r;(n=t[O][2])==null||n.forEach(([s,o])=>{s.values.push(o)});try{_t(e,t,void 0)}catch{return}if(t.a){delete t.a;return}(r=t[O][2])==null||r.forEach(([s])=>{s.values.pop()}),(e[0]!==1||!e[1])&&zn(t,t.c,!1)},$e=new WeakMap,ln=[],lt=async(e,t)=>{e[5]||(e[5]=[]);const n=$e.get(t);n&&n[0](void 0);let r;const s=new Promise(o=>r=o);if($e.set(t,[r,()=>{e[2]?e[2](e,t,o=>{an(o,t)}).then(()=>r(t)):(an(e,t),r(t))}]),ln.length)ln.at(-1).add(t);else{await Promise.resolve();const o=$e.get(t);o&&($e.delete(t),o[1]())}return s},as=(e,t,n)=>({tag:ze,props:{children:e},key:n,e:t,p:1}),At=0,He=1,Ct=2,xt=3,Et=new WeakMap,Kt=(e,t)=>!e||!t||e.length!==t.length||t.some((n,r)=>n!==e[r]),is=void 0,cn=[],Ue=e=>{var a;const t=()=>typeof e=="function"?e():e,n=De.at(-1);if(!n)return[t(),()=>{}];const[,r]=n,s=(a=r[O][1])[At]||(a[At]=[]),o=r[O][0]++;return s[o]||(s[o]=[t(),i=>{const l=is,u=s[o];if(typeof i=="function"&&(i=i(u[0])),!Object.is(i,u[0]))if(u[0]=i,cn.length){const[d,h]=cn.at(-1);Promise.all([d===3?r:lt([d,!1,l],r),h]).then(([f])=>{if(!f||!(d===2||d===3))return;const g=f.vC;requestAnimationFrame(()=>{setTimeout(()=>{g===f.vC&&lt([d===3?1:0,!1,l],f)})})})}else lt([0,!1,l],r)}])},ls=(e,t,n)=>{var u;const r=De.at(-1);if(!r)return;const[,s]=r,o=(u=s[O][1])[He]||(u[He]=[]),a=s[O][0]++,[i,,l]=o[a]||(o[a]=[]);if(Kt(i,n)){l&&l();const d=()=>{h[e]=void 0,h[2]=t()},h=[n,void 0,void 0,void 0,void 0];h[e]=d,o[a]=h}},un=(e,t)=>ls(3,e,t),qt=(e,t)=>{var i;const n=De.at(-1);if(!n)return e;const[,r]=n,s=(i=r[O][1])[Ct]||(i[Ct]=[]),o=r[O][0]++,a=s[o];return Kt(a==null?void 0:a[1],t)?s[o]=[e,t]:e=s[o][0],e},cs=e=>{const t=Et.get(e);if(t){if(t.length===2)throw t[1];return t[0]}throw e.then(n=>Et.set(e,[n]),n=>Et.set(e,[void 0,n])),e},us=(e,t)=>{var i;const n=De.at(-1);if(!n)return e();const[,r]=n,s=(i=r[O][1])[xt]||(i[xt]=[]),o=r[O][0]++,a=s[o];return Kt(a==null?void 0:a[1],t)&&(s[o]=[e(),t]),s[o][0]},ds=$n({pending:!1,data:null,method:null,action:null}),dn=new Set,hs=e=>{dn.add(e),e.finally(()=>dn.delete(e))},Vt=(e,t)=>us(()=>n=>{let r;e&&(typeof e=="function"?r=e(n)||(()=>{e(null)}):e&&"current"in e&&(e.current=n,r=()=>{e.current=null}));const s=t(n);return()=>{s==null||s(),r==null||r()}},[e]),Ce=Object.create(null),nt=Object.create(null),tt=(e,t,n,r,s)=>{if(t!=null&&t.itemProp)return{tag:e,props:t,type:e,ref:t.ref};const o=document.head;let{onLoad:a,onError:i,precedence:l,blocking:u,...d}=t,h=null,f=!1;const g=st[e];let v;if(g.length>0){const A=o.querySelectorAll(e);e:for(const C of A)for(const E of st[e])if(C.getAttribute(E)===t[E]){h=C;break e}if(!h){const C=g.reduce((E,R)=>t[R]===void 0?E:`${E}-${R}-${t[R]}`,e);f=!nt[C],h=nt[C]||(nt[C]=(()=>{const E=document.createElement(e);for(const R of g)t[R]!==void 0&&E.setAttribute(R,t[R]),t.rel&&E.setAttribute("rel",t.rel);return E})())}}else v=o.querySelectorAll(e);l=r?l??"":void 0,r&&(d[ot]=l);const m=qt(A=>{if(g.length>0){let C=!1;for(const E of o.querySelectorAll(e)){if(C&&E.getAttribute(ot)!==l){o.insertBefore(A,E);return}E.getAttribute(ot)===l&&(C=!0)}o.appendChild(A)}else if(v){let C=!1;for(const E of v)if(E===A){C=!0;break}C||o.insertBefore(A,o.contains(v[0])?v[0]:o.querySelector(e)),v=void 0}},[l]),y=Vt(t.ref,A=>{var R;const C=g[0];if(n===2&&(A.innerHTML=""),(f||v)&&m(A),!i&&!a)return;let E=Ce[R=A.getAttribute(C)]||(Ce[R]=new Promise((q,V)=>{A.addEventListener("load",q),A.addEventListener("error",V)}));a&&(E=E.then(a)),i&&(E=E.catch(i)),E.catch(()=>{})});if(s&&u==="render"){const A=st[e][0];if(t[A]){const C=t[A],E=Ce[C]||(Ce[C]=new Promise((R,q)=>{m(h),h.addEventListener("load",R),h.addEventListener("error",q)}));cs(E)}}const S={tag:e,type:e,props:{...d,ref:y},ref:y};return S.p=n,h&&(S.e=h),as(S,o)},fs=e=>{const t=es(),n=t&&Ae(t);return n!=null&&n.endsWith("svg")?{tag:"title",props:e,type:"title",ref:e.ref}:tt("title",e,void 0,!1,!1)},ps=e=>!e||["src","async"].some(t=>!e[t])?{tag:"script",props:e,type:"script",ref:e.ref}:tt("script",e,1,!1,!0),ms=e=>!e||!["href","precedence"].every(t=>t in e)?{tag:"style",props:e,type:"style",ref:e.ref}:(e["data-href"]=e.href,delete e.href,tt("style",e,2,!0,!0)),gs=e=>!e||["onLoad","onError"].some(t=>t in e)||e.rel==="stylesheet"&&(!("precedence"in e)||"disabled"in e)?{tag:"link",props:e,type:"link",ref:e.ref}:tt("link",e,1,"precedence"in e,!0),bs=e=>tt("meta",e,void 0,!1,!1),Kn=Symbol(),vs=e=>{const{action:t,...n}=e;typeof t!="function"&&(n.action=t);const[r,s]=Ue([null,!1]),o=qt(async u=>{const d=u.isTrusted?t:u.detail[Kn];if(typeof d!="function")return;u.preventDefault();const h=new FormData(u.target);s([h,!0]);const f=d(h);f instanceof Promise&&(hs(f),await f),s([null,!0])},[]),a=Vt(e.ref,u=>(u.addEventListener("submit",o),()=>{u.removeEventListener("submit",o)})),[i,l]=r;return r[1]=!1,{tag:ds,props:{value:{pending:i!==null,data:i,method:i?"post":null,action:i?t:null},children:{tag:"form",props:{...n,ref:a},type:"form",ref:a}},f:l}},qn=(e,{formAction:t,...n})=>{if(typeof t=="function"){const r=qt(s=>{s.preventDefault(),s.currentTarget.form.dispatchEvent(new CustomEvent("submit",{detail:{[Kn]:t}}))},[]);n.ref=Vt(n.ref,s=>(s.addEventListener("click",r),()=>{s.removeEventListener("click",r)}))}return{tag:e,props:n,type:e,ref:n.ref}},ys=e=>qn("input",e),Ss=e=>qn("button",e);Object.assign(Lt,{title:fs,script:ps,style:ms,link:gs,meta:bs,form:vs,input:ys,button:Ss});new TextEncoder;var ws=Gt(null),As=(e,t,n,r)=>(s,o)=>{const a="<!DOCTYPE html>",i=n?Nt(u=>n(u,e),{Layout:t,...o},s):s,l=$r`${F(a)}${Nt(ws.Provider,{value:e},i)}`;return e.html(l)},Cs=(e,t)=>function(r,s){const o=r.getLayout()??je;return e&&r.setLayout(a=>e({...a,Layout:o},r)),r.setRenderer(As(r,o,e)),s()};const xs=Cs(({children:e})=>p("html",{lang:"en",children:[p("head",{children:[p("meta",{charset:"utf-8"}),p("meta",{name:"viewport",content:"width=device-width, initial-scale=1.0"}),p("link",{href:"/favicon.ico",rel:"icon"}),p(Go,{href:"/app/style.css",rel:"stylesheet"}),p(Bo,{src:"/app/client.ts",async:!0})]}),p("body",{children:e})]})),Es=Object.freeze(Object.defineProperty({__proto__:null,default:xs},Symbol.toStringTag,{value:"Module"}));function Vn(e){return[/github\.com\/[^\/]+\/[^\/]+/,/qiita\.com\/[^\/]+\/items/,/qiita\.com\/tags/,/zenn\.dev\/[^\/]+\/articles/,/zenn\.dev\/[^\/]+\/books/,/zenn\.dev\/topics/,/dev\.classmethod\.jp\/articles/,/speakerdeck\.com\/[^\/]+\/[^\/]+/,/x\.com\/[^\/]+\/status/,/x\.com\/search/,/docswell\.com\/slide/].some(r=>r.test(e))?!1:[/https?:\/\/dev\.classmethod\.jp\/author\/[a-zA-Z0-9_-]+$/,/https?:\/\/github\.com\/[a-zA-Z0-9_-]+$/,/https?:\/\/zenn\.dev\/[a-zA-Z0-9_-]+$/,/https?:\/\/speakerdeck\.com\/[a-zA-Z0-9_-]+$/,/https?:\/\/x\.com\/[a-zA-Z0-9_-]+$/,/https?:\/\/qiita\.com\/[a-zA-Z0-9_-]+$/,/https?:\/\/www\.docswell\.com\/user\/[a-zA-Z0-9_-]+$/].some(r=>r.test(e))}function ks(e){const t=/\[([^\]]+)\]\(([^)]+)\)/g;let n;for(;(n=t.exec(e))!==null;){const r=n[2];if(Vn(r))return!0}return!1}function Rs(e,t){if(!ks(e))return e;const n={"dev.classmethod.jp":{name:"DevelopersIO",logo:"amazonaws",color:"orange",usernameRegex:/dev\.classmethod\.jp\/author\/([^\/\s\)]+)/},"github.com":{name:"GitHub",logo:"github",color:"black",usernameRegex:/github\.com\/([^\/\s\)]+)/},"zenn.dev":{name:"Zenn",logo:"zenn",color:"blue",usernameRegex:/zenn\.dev\/([^\/\s\)]+)/},"speakerdeck.com":{name:"Speaker--Deck",logo:"speakerdeck",color:"green",usernameRegex:/speakerdeck\.com\/([^\/\s\)]+)/},"x.com":{name:"X",logo:"x",color:"black",usernameRegex:/x\.com\/([^\/\s\)]+)/},"qiita.com":{name:"Qiita",logo:"qiita",color:"brightgreen",usernameRegex:/qiita\.com\/([^\/\s\)]+)/},"www.docswell.com":{name:"Docswell",logo:"readthedocs",color:"blue",usernameRegex:/www\.docswell\.com\/user\/([^\/\s\)]+)/}};let r=e;return Object.entries(n).forEach(([s,o])=>{const a=new RegExp(`\\[([^\\]]+)\\]\\(https?://${s.replace(/\./g,"\\.")}[^\\)]*\\)`,"g");r=r.replace(a,i=>{try{const l=i.match(/\[([^\]]+)\]\(([^)]+)\)/);if(!l)return i;const u=l[2];if(!Vn(u))return i;const d=i.match(o.usernameRegex),h=d?d[1]:"";if(h){const f=encodeURIComponent(`${o.name}-@${h}`),g=encodeURIComponent(o.logo),v=encodeURIComponent(o.color),m=`https://img.shields.io/badge/${f}-${v}?style=flat&logo=${g}`;return`<a href="${u}" target="_blank" rel="noopener"><img src="${m}" alt="${o.name}" /></a>`}else{const f=encodeURIComponent(o.name),g=encodeURIComponent(o.logo),v=encodeURIComponent(o.color),m=`https://img.shields.io/badge/${f}-${v}?style=flat&logo=${g}`;return`<a href="${u}" target="_blank" rel="noopener"><img src="${m}" alt="${o.name}" /></a>`}}catch(l){return console.warn("Error converting account link:",l),i}})}),r}const Os="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800 border border-blue-200 shadow-sm hover:bg-blue-200 transition-colors duration-200",kt=/^\d+\.\s/;function Ps(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function hn(e,t){return`<li class="ml-4 mb-2 flex items-start"><span class="mr-2 text-blue-500">${t}</span><span>${Me(e)}</span></li>`}function Jn(e){return e.replace(/\*\*([^*]+)\*\*/g,'<strong class="font-bold">$1</strong>').replace(new RegExp("(?<!\\*)\\*([^*]+)\\*(?!\\*)","g"),'<em class="italic">$1</em>').replace(/`([^`]+)`/g,`<code class="${Os}">$1</code>`)}function Me(e){return Jn(e.replace(/\[([^\]]+)\]\(([^)]+)\)/g,'<a href="$2" class="text-blue-600 hover:underline" target="_blank" rel="noopener">$1</a>'))}function Is(e){var s;const t=e.trim().split(`
...
\`\`\`txt
AWS のアーキテクチャ設計・構築を専門にしていました。
モノリシック、静的ウェブサイトホスティング、マイクロサービス、CICD パイプライン、マルチアカウント、サーバレスといった様々なパターンの設計・構築経験があります。  
...
\`\`\`txt
クラウドの中でも特に生成 AI、RAG、及び AI エージェントの分野に特化し、様々な情報を発信しています。  
...
\`\`\`txt
インフラのみならず、バックエンドの開発経験も持ち合わせているためフルスタックな活躍が可能です。  
アーキテクチャとしては、主に Lambda や ECS Fargate、Cloud Run 上でのサーバレスアプリケーション設計・開発を行ってきました。  
言語としては主に Python 及び TypeScript を使用した開発経験があります。    
\`\`\`
...
\`Cloud Run\` \`Alloy DB\` \`BigQuery\` \`Datastream\`
...
### 株式会社ゼスト(2025/3 - 2025/8)

\`\`\`txt
主にバックエンドエンジニアとして、在宅医療Webアプリケーションの設計/開発を担当しました。  
\`\`\`

#### ZEST SCHEDULE開発(2025/3 - 2025/8)

**概要**

訪問看護・訪問介護事業所向けのスケジュール作成・管理ツールをフルスクラッチで開発
...
1. 介護事業者向けZEST SCHEDULEの開発
2. 社内関係者向けZEST SCHEDULE ADMINの設計/開発

**使用技術**

- 言語・フレームワーク：\`TypeScript\` \`Node.js\` \`Fastify\` \`Prisma\`
- Google Cloudサービス：\`Cloud Run\` \`Alloy DB\` \`BigQuery\` \`Datastream\`
- SaaS：\`GitHub\` \`GitHub Actions\`

### クラスメソッド株式会社(2022/3 - 2025/6)

\`\`\`txt
主にソリューションアーキテクトとして、モノリシック、静的ウェブサイトホスティング、マイクロサービス、CICD パイプライン、マルチアカウント、サーバレスといった様々なAWS アーキテクチャの/設計/構築を担当しました。  
PJに応じて、バックエンドエンジニアとしてアプリケーション開発を行ったり、生成AIエンジニアとして生成AI及びRAG関連案件の対応を行っていました。  
またプロジェクトマネージャーを兼任し、多くのPJでチームマネジメント及び顧客折衝を行っていました。   
\`\`\`
...
生成 AI を活用した自社SaaSチャットボットアプリをフルスクラッチで開発
...
複数の AWS アカウントに対する通知設定を一括で付与できる、通知集約システムを開発
...
SaaS から出力されるログを定期的に AWS にアップロードし、特定用途で使用するためのログ形式に加工するサーバレスアプリ及びCICDシステムをフルスクラッチで開発
...
1. 技術営業
2. 顧客折衝
3. マルチアカウント基盤設計に必要な技術質問対応
4. マルチアカウント基盤構築に必要な動作検証
...
1. チームマネジメント(3 人)
2. 顧客折衝
3. 静的ウェブサイトホスティングインフラ設計書作成
4. 静的ウェブサイトホスティングインフラ構築
5. 静的ウェブサイトホスティングインフラ試験
...
\`\`\`txt
主にインフラエンジニアとして、オンプレミスにおける Linux サーバの設計/構築を担当しました。  
またWASやOracle といったミドルウェアの設計/構築も行っていました。  
さらにコンテナ技術(Docker/Kubernetes)の検証にも積極的に取り組み、社内外での導入を推進しました。  
\`\`\`
...
AWSを基盤とするWebアプリケーションの設計/開発を行う自社開発企業にて、アーキテクチャの相談役として参画
...
- [初めてのGPTs 〜ネコ派を◯◯派に変える技術〜 - Speaker Deck](https://speakerdeck.com/player/5cd9a55bb15c4ccd9ff933ed8430d513)
...
`;function eo(){const e=Ns(Qs),n=(r=>{const s=[];let o=null,a=[];return r.forEach(i=>{!i.title&&i.level===0?s.push({type:"intro",section:i}):i.level===1||i.level===2?(o&&(s.push({type:"h3-group",section:o,subsections:a}),o=null,a=[]),s.push({type:"regular",section:i})):i.level===3?(o&&s.push({type:"h3-group",section:o,subsections:a}),o=i,a=[]):i.level===4&&o?a.push(i):(o&&(s.push({type:"h3-group",section:o,subsections:a}),o=null,a=[]),s.push({type:"regular",section:i}))}),o&&s.push({type:"h3-group",section:o,subsections:a}),s})(e);return p("div",{className:"min-h-screen bg-gray-50",children:p("div",{className:"max-w-4xl mx-auto py-8 px-4",children:[p("header",{className:"text-center mb-12",children:[p("h1",{className:"text-4xl font-bold text-gray-900 mb-4",children:"職務経歴書"}),p(Ys,{})]}),p("main",{className:"bg-white rounded-lg shadow-lg p-8",children:n.map((r,s)=>{if(r.type==="intro")return p("div",{className:"mb-8",dangerouslySetInnerHTML:{__html:`<p class="mb-4">${Ne(r.section.content)}</p>`}},r.section.id);if(r.type==="h3-group")return p(qs,{section:r.section,subsections:r.subsections||[]},r.section.id);{const o=Ne(r.section.content);return p(Fs,{title:r.section.title,content:o,level:r.section.level,defaultOpen:r.section.level<=2},r.section.id)}})}),p("footer",{className:"text-center mt-12 text-gray-500",children:[p("p",{children:"Built with HonoX on GitHub Pages"}),p("p",{className:"mt-2",children:["Generated by: ",p("a",{href:"https://zenn.dev/tsukuboshi/articles/honox-resume",target:"_blank",rel:"noopener noreferrer",className:"text-blue-600 hover:text-blue-800 underline",children:"Markdownで書いた職務経歴書を良い感じのWebサイトとPDFに自動変換するツールを作ってみた"})]})]})]})})}const to=!0,no=Object.freeze(Object.defineProperty({__proto__:null,__importing_islands:to,default:eo},Symbol.toStringTag,{value:"Module"}));var pn=(e,t,n)=>(r,s)=>{let o=-1;return a(0);async function a(i){if(i<=o)throw new Error("next() called multiple times");o=i;let l,u=!1,d;if(e[i]?(d=e[i][0][0],r.req.routeIndex=i):d=i===e.length&&s||void 0,d)try{l=await d(r,()=>a(i+1))}catch(h){if(h instanceof Error&&t)r.error=h,l=await t(h,r),u=!0;else throw h}else r.finalized===!1&&n&&(l=await n(r));return l&&(r.finalized===!1||u)&&(r.res=l),r}},ro=async(e,t=Object.create(null))=>{const{all:n=!1,dot:r=!1}=t,o=(e instanceof sr?e.raw.headers:e.headers).get("Content-Type");return o!=null&&o.startsWith("multipart/form-data")||o!=null&&o.startsWith("application/x-www-form-urlencoded")?so(e,{all:n,dot:r}):{}};async function so(e,t){const n=await e.formData();return n?oo(n,t):{}}function oo(e,t){const n=Object.create(null);return e.forEach((r,s)=>{t.all||s.endsWith("[]")?ao(n,s,r):n[s]=r}),t.dot&&Object.entries(n).forEach(([r,s])=>{r.includes(".")&&(io(n,r,s),delete n[r])}),n}var ao=(e,t,n)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(n):e[t]=[e[t],n]:e[t]=n},io=(e,t,n)=>{let r=e;const s=t.split(".");s.forEach((o,a)=>{a===s.length-1?r[o]=n:((!r[o]||typeof r[o]!="object"||Array.isArray(r[o])||r[o]instanceof File)&&(r[o]=Object.create(null)),r=r[o])})},Yn=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},lo=e=>{const{groups:t,path:n}=co(e),r=Yn(n);return uo(r,t)},co=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(n,r)=>{const s=`@${r}`;return t.push([s,n]),s}),{groups:t,path:e}},uo=(e,t)=>{for(let n=t.length-1;n>=0;n--){const[r]=t[n];for(let s=e.length-1;s>=0;s--)if(e[s].includes(r)){e[s]=e[s].replace(r,t[n][1]);break}}return e},rt={},mn=(e,t)=>{if(e==="*")return"*";const n=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(n){const r=`${e}#${t}`;return rt[r]||(n[2]?rt[r]=t&&t[0]!==":"&&t[0]!=="*"?[r,n[1],new RegExp(`^${n[2]}(?=/${t})`)]:[e,n[1],new RegExp(`^${n[2]}$`)]:rt[r]=[e,n[1],!0]),rt[r]}return null},Qn=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,n=>{try{return t(n)}catch{return n}})}},ho=e=>Qn(e,decodeURI),er=e=>{const t=e.url,n=t.indexOf("/",8);let r=n;for(;r<t.length;r++){const s=t.charCodeAt(r);if(s===37){const o=t.indexOf("?",r),a=t.slice(n,o===-1?void 0:o);return ho(a.includes("%25")?a.replace(/%25/g,"%2525"):a)}else if(s===63)break}return t.slice(n,r)},fo=e=>{const t=er(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Ee=(e,t,...n)=>(n.length&&(t=Ee(t,...n)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),tr=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),n=[];let r="";return t.forEach(s=>{if(s!==""&&!/\:/.test(s))r+="/"+s;else if(/\:/.test(s))if(/\?/.test(s)){n.length===0&&r===""?n.push("/"):n.push(r);const o=s.replace("?","");r+="/"+o,n.push(r)}else r+="/"+s}),n.filter((s,o,a)=>a.indexOf(s)===o)},Ot=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?rr(e):e):e,nr=(e,t,n)=>{let r;if(!n&&t&&!/[%+]/.test(t)){let a=e.indexOf(`?${t}`,8);for(a===-1&&(a=e.indexOf(`&${t}`,8));a!==-1;){const i=e.charCodeAt(a+t.length+1);if(i===61){const l=a+t.length+2,u=e.indexOf("&",l);return Ot(e.slice(l,u===-1?void 0:u))}else if(i==38||isNaN(i))return"";a=e.indexOf(`&${t}`,a+1)}if(r=/[%+]/.test(e),!r)return}const s={};r??(r=/[%+]/.test(e));let o=e.indexOf("?",8);for(;o!==-1;){const a=e.indexOf("&",o+1);let i=e.indexOf("=",o);i>a&&a!==-1&&(i=-1);let l=e.slice(o+1,i===-1?a===-1?void 0:a:i);if(r&&(l=Ot(l)),o=a,l==="")continue;let u;i===-1?u="":(u=e.slice(i+1,a===-1?void 0:a),r&&(u=Ot(u))),n?(s[l]&&Array.isArray(s[l])||(s[l]=[]),s[l].push(u)):s[l]??(s[l]=u)}return t?s[t]:s},po=nr,mo=(e,t)=>nr(e,t,!0),rr=decodeURIComponent,gn=e=>Qn(e,rr),ke,B,ne,or,ar,Wt,oe,Sn,sr=(Sn=class{constructor(e,t="/",n=[[]]){x(this,ne);w(this,"raw");x(this,ke);x(this,B);w(this,"routeIndex",0);w(this,"path");w(this,"bodyCache",{});x(this,oe,e=>{const{bodyCache:t,raw:n}=this,r=t[e];if(r)return r;const s=Object.keys(t)[0];return s?t[s].then(o=>(s==="json"&&(o=JSON.stringify(o)),new Response(o)[e]())):t[e]=n[e]()});this.raw=e,this.path=t,b(this,B,n),b(this,ke,{})}param(e){return e?k(this,ne,or).call(this,e):k(this,ne,ar).call(this)}query(e){return po(this.url,e)}queries(e){return mo(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((n,r)=>{t[r]=n}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await ro(this,e))}json(){return c(this,oe).call(this,"json")}text(){return c(this,oe).call(this,"text")}arrayBuffer(){return c(this,oe).call(this,"arrayBuffer")}blob(){return c(this,oe).call(this,"blob")}formData(){return c(this,oe).call(this,"formData")}addValidatedData(e,t){c(this,ke)[e]=t}valid(e){return c(this,ke)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get matchedRoutes(){return c(this,B)[0].map(([[,e]])=>e)}get routePath(){return c(this,B)[0].map(([[,e]])=>e)[this.routeIndex].path}},ke=new WeakMap,B=new WeakMap,ne=new WeakSet,or=function(e){const t=c(this,B)[0][this.routeIndex][1][e],n=k(this,ne,Wt).call(this,t);return n?/\%/.test(n)?gn(n):n:void 0},ar=function(){const e={},t=Object.keys(c(this,B)[0][this.routeIndex][1]);for(const n of t){const r=k(this,ne,Wt).call(this,c(this,B)[0][this.routeIndex][1][n]);r&&typeof r=="string"&&(e[n]=/\%/.test(r)?gn(r):r)}return e},Wt=function(e){return c(this,B)[1]?c(this,B)[1][e]:e},oe=new WeakMap,Sn),go="text/plain; charset=UTF-8",Pt=(e,t={})=>{for(const n of Object.keys(t))e.set(n,t[n]);return e},Ke,qe,X,be,Y,I,j,M,Q,Ve,Re,Oe,Je,Ze,$,H,wn,bo=(wn=class{constructor(e,t){x(this,$);x(this,Ke);x(this,qe);w(this,"env",{});x(this,X);w(this,"finalized",!1);w(this,"error");x(this,be,200);x(this,Y);x(this,I);x(this,j);x(this,M);x(this,Q,!0);x(this,Ve);x(this,Re);x(this,Oe);x(this,Je);x(this,Ze);w(this,"render",(...e)=>(c(this,Re)??b(this,Re,t=>this.html(t)),c(this,Re).call(this,...e)));w(this,"setLayout",e=>b(this,Ve,e));w(this,"getLayout",()=>c(this,Ve));w(this,"setRenderer",e=>{b(this,Re,e)});w(this,"header",(e,t,n)=>{if(this.finalized&&b(this,M,new Response(c(this,M).body,c(this,M))),t===void 0){c(this,I)?c(this,I).delete(e):c(this,j)&&delete c(this,j)[e.toLocaleLowerCase()],this.finalized&&this.res.headers.delete(e);return}n!=null&&n.append?(c(this,I)||(b(this,Q,!1),b(this,I,new Headers(c(this,j))),b(this,j,{})),c(this,I).append(e,t)):c(this,I)?c(this,I).set(e,t):(c(this,j)??b(this,j,{}),c(this,j)[e.toLowerCase()]=t),this.finalized&&(n!=null&&n.append?this.res.headers.append(e,t):this.res.headers.set(e,t))});w(this,"status",e=>{b(this,Q,!1),b(this,be,e)});w(this,"set",(e,t)=>{c(this,X)??b(this,X,new Map),c(this,X).set(e,t)});w(this,"get",e=>c(this,X)?c(this,X).get(e):void 0);w(this,"newResponse",(...e)=>k(this,$,H).call(this,...e));w(this,"body",(e,t,n)=>typeof t=="number"?k(this,$,H).call(this,e,t,n):k(this,$,H).call(this,e,t));w(this,"text",(e,t,n)=>{if(!c(this,j)){if(c(this,Q)&&!n&&!t)return new Response(e);b(this,j,{})}return c(this,j)["content-type"]=go,typeof t=="number"?k(this,$,H).call(this,e,t,n):k(this,$,H).call(this,e,t)});w(this,"json",(e,t,n)=>{const r=JSON.stringify(e);return c(this,j)??b(this,j,{}),c(this,j)["content-type"]="application/json",typeof t=="number"?k(this,$,H).call(this,r,t,n):k(this,$,H).call(this,r,t)});w(this,"html",(e,t,n)=>(c(this,j)??b(this,j,{}),c(this,j)["content-type"]="text/html; charset=UTF-8",typeof e=="object"?Nn(e,jn.Stringify,!1,{}).then(r=>typeof t=="number"?k(this,$,H).call(this,r,t,n):k(this,$,H).call(this,r,t)):typeof t=="number"?k(this,$,H).call(this,e,t,n):k(this,$,H).call(this,e,t)));w(this,"redirect",(e,t)=>(c(this,I)??b(this,I,new Headers),c(this,I).set("Location",String(e)),this.newResponse(null,t??302)));w(this,"notFound",()=>(c(this,Oe)??b(this,Oe,()=>new Response),c(this,Oe).call(this,this)));b(this,Ke,e),t&&(b(this,Y,t.executionCtx),this.env=t.env,b(this,Oe,t.notFoundHandler),b(this,Ze,t.path),b(this,Je,t.matchResult))}get req(){return c(this,qe)??b(this,qe,new sr(c(this,Ke),c(this,Ze),c(this,Je))),c(this,qe)}get event(){if(c(this,Y)&&"respondWith"in c(this,Y))return c(this,Y);throw Error("This context has no FetchEvent")}get executionCtx(){if(c(this,Y))return c(this,Y);throw Error("This context has no ExecutionContext")}get res(){return b(this,Q,!1),c(this,M)||b(this,M,new Response("404 Not Found",{status:404}))}set res(e){if(b(this,Q,!1),c(this,M)&&e){e=new Response(e.body,e);for(const[t,n]of c(this,M).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const r=c(this,M).headers.getSetCookie();e.headers.delete("set-cookie");for(const s of r)e.headers.append("set-cookie",s)}else e.headers.set(t,n)}b(this,M,e),this.finalized=!0}get var(){return c(this,X)?Object.fromEntries(c(this,X)):{}}},Ke=new WeakMap,qe=new WeakMap,X=new WeakMap,be=new WeakMap,Y=new WeakMap,I=new WeakMap,j=new WeakMap,M=new WeakMap,Q=new WeakMap,Ve=new WeakMap,Re=new WeakMap,Oe=new WeakMap,Je=new WeakMap,Ze=new WeakMap,$=new WeakSet,H=function(e,t,n){if(c(this,Q)&&!n&&!t&&c(this,be)===200)return new Response(e,{headers:c(this,j)});if(t&&typeof t!="number"){const s=new Headers(t.headers);c(this,I)&&c(this,I).forEach((a,i)=>{i==="set-cookie"?s.append(i,a):s.set(i,a)});const o=Pt(s,c(this,j));return new Response(e,{headers:o,status:t.status??c(this,be)})}const r=typeof t=="number"?t:c(this,be);c(this,j)??b(this,j,{}),c(this,I)??b(this,I,new Headers),Pt(c(this,I),c(this,j)),c(this,M)&&(c(this,M).headers.forEach((s,o)=>{var a,i;o==="set-cookie"?(a=c(this,I))==null||a.append(o,s):(i=c(this,I))==null||i.set(o,s)}),Pt(c(this,I),c(this,j))),n??(n={});for(const[s,o]of Object.entries(n))if(typeof o=="string")c(this,I).set(s,o);else{c(this,I).delete(s);for(const a of o)c(this,I).append(s,a)}return new Response(e,{status:r,headers:c(this,I)})},wn),D="ALL",vo="all",yo=["get","post","put","delete","options","patch"],ir="Can not add a route since the matcher is already built.",lr=class extends Error{},So=e=>e.text("404 Not Found",404),bn=(e,t)=>{if("getResponse"in e){const n=e.getResponse();return t.newResponse(n.body,n)}return console.error(e),t.text("Internal Server Error",500)},G,L,ur,z,me,ct,ut,An,cr=(An=class{constructor(t={}){x(this,L);w(this,"get");w(this,"post");w(this,"put");w(this,"delete");w(this,"options");w(this,"patch");w(this,"all");w(this,"on");w(this,"use");w(this,"router");w(this,"getPath");w(this,"_basePath","/");x(this,G,"/");w(this,"routes",[]);x(this,z,So);w(this,"errorHandler",bn);w(this,"onError",t=>(this.errorHandler=t,this));w(this,"notFound",t=>(b(this,z,t),this));w(this,"fetch",(t,...n)=>k(this,L,ut).call(this,t,n[1],n[0],t.method));w(this,"request",(t,n,r,s)=>t instanceof Request?this.fetch(n?new Request(t,n):t,r,s):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Ee("/",t)}`,n),r,s)));w(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(k(this,L,ut).call(this,t.request,t,void 0,t.request.method))})});[...yo,vo].forEach(o=>{this[o]=(a,...i)=>(typeof a=="string"?b(this,G,a):k(this,L,me).call(this,o,c(this,G),a),i.forEach(l=>{k(this,L,me).call(this,o,c(this,G),l)}),this)}),this.on=(o,a,...i)=>{for(const l of[a].flat()){b(this,G,l);for(const u of[o].flat())i.map(d=>{k(this,L,me).call(this,u.toUpperCase(),c(this,G),d)})}return this},this.use=(o,...a)=>(typeof o=="string"?b(this,G,o):(b(this,G,"*"),a.unshift(o)),a.forEach(i=>{k(this,L,me).call(this,D,c(this,G),i)}),this);const{strict:r,...s}=t;Object.assign(this,s),this.getPath=r??!0?t.getPath??er:fo}route(t,n){const r=this.basePath(t);return n.routes.map(s=>{var a;let o;n.errorHandler===bn?o=s.handler:(o=async(i,l)=>(await pn([],n.errorHandler)(i,()=>s.handler(i,l))).res,o[jt]=s.handler),k(a=r,L,me).call(a,s.method,s.path,o)}),this}basePath(t){const n=k(this,L,ur).call(this);return n._basePath=Ee(this._basePath,t),n}mount(t,n,r){let s,o;r&&(typeof r=="function"?o=r:(o=r.optionHandler,r.replaceRequest===!1?s=l=>l:s=r.replaceRequest));const a=o?l=>{const u=o(l);return Array.isArray(u)?u:[u]}:l=>{let u;try{u=l.executionCtx}catch{}return[l.env,u]};s||(s=(()=>{const l=Ee(this._basePath,t),u=l==="/"?0:l.length;return d=>{const h=new URL(d.url);return h.pathname=h.pathname.slice(u)||"/",new Request(h,d)}})());const i=async(l,u)=>{const d=await n(s(l.req.raw),...a(l));if(d)return d;await u()};return k(this,L,me).call(this,D,Ee(t,"*"),i),this}},G=new WeakMap,L=new WeakSet,ur=function(){const t=new cr({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,b(t,z,c(this,z)),t.routes=this.routes,t},z=new WeakMap,me=function(t,n,r){t=t.toUpperCase(),n=Ee(this._basePath,n);const s={path:n,method:t,handler:r};this.router.add(t,n,[r,s]),this.routes.push(s)},ct=function(t,n){if(t instanceof Error)return this.errorHandler(t,n);throw t},ut=function(t,n,r,s){if(s==="HEAD")return(async()=>new Response(null,await k(this,L,ut).call(this,t,n,r,"GET")))();const o=this.getPath(t,{env:r}),a=this.router.match(s,o),i=new bo(t,{path:o,matchResult:a,env:r,executionCtx:n,notFoundHandler:c(this,z)});if(a[0].length===1){let u;try{u=a[0][0][0][0](i,async()=>{i.res=await c(this,z).call(this,i)})}catch(d){return k(this,L,ct).call(this,d,i)}return u instanceof Promise?u.then(d=>d||(i.finalized?i.res:c(this,z).call(this,i))).catch(d=>k(this,L,ct).call(this,d,i)):u??c(this,z).call(this,i)}const l=pn(a[0],this.errorHandler,c(this,z));return(async()=>{try{const u=await l(i);if(!u.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return u.res}catch(u){return k(this,L,ct).call(this,u,i)}})()},An),mt="[^/]+",Fe=".*",Be="(?:|/.*)",We=Symbol(),wo=new Set(".\\+*[^]$()");function Ao(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===Fe||e===Be?1:t===Fe||t===Be?-1:e===mt?1:t===mt?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var ve,ye,U,Cn,Ht=(Cn=class{constructor(){x(this,ve);x(this,ye);x(this,U,Object.create(null))}insert(t,n,r,s,o){if(t.length===0){if(c(this,ve)!==void 0)throw We;if(o)return;b(this,ve,n);return}const[a,...i]=t,l=a==="*"?i.length===0?["","",Fe]:["","",mt]:a==="/*"?["","",Be]:a.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let u;if(l){const d=l[1];let h=l[2]||mt;if(d&&l[2]&&(h=h.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(h)))throw We;if(u=c(this,U)[h],!u){if(Object.keys(c(this,U)).some(f=>f!==Fe&&f!==Be))throw We;if(o)return;u=c(this,U)[h]=new Ht,d!==""&&b(u,ye,s.varIndex++)}!o&&d!==""&&r.push([d,c(u,ye)])}else if(u=c(this,U)[a],!u){if(Object.keys(c(this,U)).some(d=>d.length>1&&d!==Fe&&d!==Be))throw We;if(o)return;u=c(this,U)[a]=new Ht}u.insert(i,n,r,s,o)}buildRegExpStr(){const n=Object.keys(c(this,U)).sort(Ao).map(r=>{const s=c(this,U)[r];return(typeof c(s,ye)=="number"?`(${r})@${c(s,ye)}`:wo.has(r)?`\\${r}`:r)+s.buildRegExpStr()});return typeof c(this,ve)=="number"&&n.unshift(`#${c(this,ve)}`),n.length===0?"":n.length===1?n[0]:"(?:"+n.join("|")+")"}},ve=new WeakMap,ye=new WeakMap,U=new WeakMap,Cn),gt,Xe,xn,Co=(xn=class{constructor(){x(this,gt,{varIndex:0});x(this,Xe,new Ht)}insert(e,t,n){const r=[],s=[];for(let a=0;;){let i=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const u=`@\\${a}`;return s[a]=[u,l],a++,i=!0,u}),!i)break}const o=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let a=s.length-1;a>=0;a--){const[i]=s[a];for(let l=o.length-1;l>=0;l--)if(o[l].indexOf(i)!==-1){o[l]=o[l].replace(i,s[a][1]);break}}return c(this,Xe).insert(o,t,r,c(this,gt),n),r}buildRegExp(){let e=c(this,Xe).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const n=[],r=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(s,o,a)=>o!==void 0?(n[++t]=Number(o),"$()"):(a!==void 0&&(r[Number(a)]=++t),"")),[new RegExp(`^${e}`),n,r]}},gt=new WeakMap,Xe=new WeakMap,xn),dr=[],xo=[/^$/,[],Object.create(null)],dt=Object.create(null);function hr(e){return dt[e]??(dt[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,n)=>n?`\\${n}`:"(?:|/.*)")}$`))}function Eo(){dt=Object.create(null)}function ko(e){var u;const t=new Co,n=[];if(e.length===0)return xo;const r=e.map(d=>[!/\*|\/:/.test(d[0]),...d]).sort(([d,h],[f,g])=>d?1:f?-1:h.length-g.length),s=Object.create(null);for(let d=0,h=-1,f=r.length;d<f;d++){const[g,v,m]=r[d];g?s[v]=[m.map(([S])=>[S,Object.create(null)]),dr]:h++;let y;try{y=t.insert(v,h,g)}catch(S){throw S===We?new lr(v):S}g||(n[h]=m.map(([S,A])=>{const C=Object.create(null);for(A-=1;A>=0;A--){const[E,R]=y[A];C[E]=R}return[S,C]}))}const[o,a,i]=t.buildRegExp();for(let d=0,h=n.length;d<h;d++)for(let f=0,g=n[d].length;f<g;f++){const v=(u=n[d][f])==null?void 0:u[1];if(!v)continue;const m=Object.keys(v);for(let y=0,S=m.length;y<S;y++)v[m[y]]=i[v[m[y]]]}const l=[];for(const d in a)l[d]=n[a[d]];return[o,l,s]}function xe(e,t){if(e){for(const n of Object.keys(e).sort((r,s)=>s.length-r.length))if(hr(n).test(t))return[...e[n]]}}var ae,ie,Te,fr,pr,En,Ro=(En=class{constructor(){x(this,Te);w(this,"name","RegExpRouter");x(this,ae);x(this,ie);b(this,ae,{[D]:Object.create(null)}),b(this,ie,{[D]:Object.create(null)})}add(e,t,n){var i;const r=c(this,ae),s=c(this,ie);if(!r||!s)throw new Error(ir);r[e]||[r,s].forEach(l=>{l[e]=Object.create(null),Object.keys(l[D]).forEach(u=>{l[e][u]=[...l[D][u]]})}),t==="/*"&&(t="*");const o=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=hr(t);e===D?Object.keys(r).forEach(u=>{var d;(d=r[u])[t]||(d[t]=xe(r[u],t)||xe(r[D],t)||[])}):(i=r[e])[t]||(i[t]=xe(r[e],t)||xe(r[D],t)||[]),Object.keys(r).forEach(u=>{(e===D||e===u)&&Object.keys(r[u]).forEach(d=>{l.test(d)&&r[u][d].push([n,o])})}),Object.keys(s).forEach(u=>{(e===D||e===u)&&Object.keys(s[u]).forEach(d=>l.test(d)&&s[u][d].push([n,o]))});return}const a=tr(t)||[t];for(let l=0,u=a.length;l<u;l++){const d=a[l];Object.keys(s).forEach(h=>{var f;(e===D||e===h)&&((f=s[h])[d]||(f[d]=[...xe(r[h],d)||xe(r[D],d)||[]]),s[h][d].push([n,o-u+l+1]))})}}match(e,t){Eo();const n=k(this,Te,fr).call(this);return this.match=(r,s)=>{const o=n[r]||n[D],a=o[2][s];if(a)return a;const i=s.match(o[0]);if(!i)return[[],dr];const l=i.indexOf("",1);return[o[1][l],i]},this.match(e,t)}},ae=new WeakMap,ie=new WeakMap,Te=new WeakSet,fr=function(){const e=Object.create(null);return Object.keys(c(this,ie)).concat(Object.keys(c(this,ae))).forEach(t=>{e[t]||(e[t]=k(this,Te,pr).call(this,t))}),b(this,ae,b(this,ie,void 0)),e},pr=function(e){const t=[];let n=e===D;return[c(this,ae),c(this,ie)].forEach(r=>{const s=r[e]?Object.keys(r[e]).map(o=>[o,r[e][o]]):[];s.length!==0?(n||(n=!0),t.push(...s)):e!==D&&t.push(...Object.keys(r[D]).map(o=>[o,r[D][o]]))}),n?ko(t):null},En),le,ee,kn,Oo=(kn=class{constructor(e){w(this,"name","SmartRouter");x(this,le,[]);x(this,ee,[]);b(this,le,e.routers)}add(e,t,n){if(!c(this,ee))throw new Error(ir);c(this,ee).push([e,t,n])}match(e,t){if(!c(this,ee))throw new Error("Fatal error");const n=c(this,le),r=c(this,ee),s=n.length;let o=0,a;for(;o<s;o++){const i=n[o];try{for(let l=0,u=r.length;l<u;l++)i.add(...r[l]);a=i.match(e,t)}catch(l){if(l instanceof lr)continue;throw l}this.match=i.match.bind(i),b(this,le,[i]),b(this,ee,void 0);break}if(o===s)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,a}get activeRouter(){if(c(this,ee)||c(this,le).length!==1)throw new Error("No active router has been determined yet.");return c(this,le)[0]}},le=new WeakMap,ee=new WeakMap,kn),_e=Object.create(null),ce,_,Se,Pe,T,te,ge,Rn,mr=(Rn=class{constructor(e,t,n){x(this,te);x(this,ce);x(this,_);x(this,Se);x(this,Pe,0);x(this,T,_e);if(b(this,_,n||Object.create(null)),b(this,ce,[]),e&&t){const r=Object.create(null);r[e]={handler:t,possibleKeys:[],score:0},b(this,ce,[r])}b(this,Se,[])}insert(e,t,n){b(this,Pe,++Xt(this,Pe)._);let r=this;const s=lo(t),o=[];for(let l=0,u=s.length;l<u;l++){const d=s[l],h=s[l+1],f=mn(d,h),g=Array.isArray(f)?f[0]:d;if(Object.keys(c(r,_)).includes(g)){r=c(r,_)[g];const v=mn(d,h);v&&o.push(v[1]);continue}c(r,_)[g]=new mr,f&&(c(r,Se).push(f),o.push(f[1])),r=c(r,_)[g]}const a=Object.create(null),i={handler:n,possibleKeys:o.filter((l,u,d)=>d.indexOf(l)===u),score:c(this,Pe)};return a[e]=i,c(r,ce).push(a),r}search(e,t){var i;const n=[];b(this,T,_e);let s=[this];const o=Yn(t),a=[];for(let l=0,u=o.length;l<u;l++){const d=o[l],h=l===u-1,f=[];for(let g=0,v=s.length;g<v;g++){const m=s[g],y=c(m,_)[d];y&&(b(y,T,c(m,T)),h?(c(y,_)["*"]&&n.push(...k(this,te,ge).call(this,c(y,_)["*"],e,c(m,T))),n.push(...k(this,te,ge).call(this,y,e,c(m,T)))):f.push(y));for(let S=0,A=c(m,Se).length;S<A;S++){const C=c(m,Se)[S],E=c(m,T)===_e?{}:{...c(m,T)};if(C==="*"){const P=c(m,_)["*"];P&&(n.push(...k(this,te,ge).call(this,P,e,c(m,T))),b(P,T,E),f.push(P));continue}if(d==="")continue;const[R,q,V]=C,W=c(m,_)[R],bt=o.slice(l).join("/");if(V instanceof RegExp){const P=V.exec(bt);if(P){if(E[q]=P[0],n.push(...k(this,te,ge).call(this,W,e,c(m,T),E)),Object.keys(c(W,_)).length){b(W,T,E);const N=((i=P[0].match(/\//))==null?void 0:i.length)??0;(a[N]||(a[N]=[])).push(W)}continue}}(V===!0||V.test(d))&&(E[q]=d,h?(n.push(...k(this,te,ge).call(this,W,e,E,c(m,T))),c(W,_)["*"]&&n.push(...k(this,te,ge).call(this,c(W,_)["*"],e,E,c(m,T)))):(b(W,T,E),f.push(W)))}}s=f.concat(a.shift()??[])}return n.length>1&&n.sort((l,u)=>l.score-u.score),[n.map(({handler:l,params:u})=>[l,u])]}},ce=new WeakMap,_=new WeakMap,Se=new WeakMap,Pe=new WeakMap,T=new WeakMap,te=new WeakSet,ge=function(e,t,n,r){const s=[];for(let o=0,a=c(e,ce).length;o<a;o++){const i=c(e,ce)[o],l=i[t]||i[D],u={};if(l!==void 0&&(l.params=Object.create(null),s.push(l),n!==_e||r&&r!==_e))for(let d=0,h=l.possibleKeys.length;d<h;d++){const f=l.possibleKeys[d],g=u[l.score];l.params[f]=r!=null&&r[f]&&!g?r[f]:n[f]??(r==null?void 0:r[f]),u[l.score]=!0}}return s},Rn),we,On,Po=(On=class{constructor(){w(this,"name","TrieRouter");x(this,we);b(this,we,new mr)}add(e,t,n){const r=tr(t);if(r){for(let s=0,o=r.length;s<o;s++)c(this,we).insert(e,r[s],n);return}c(this,we).insert(e,t,n)}match(e,t){return c(this,we).search(e,t)}},we=new WeakMap,On),ht=class extends cr{constructor(e={}){super(e),this.router=e.router??new Oo({routers:[new Ro,new Po]})}},Io=e=>e;const gr=new Rr,vn=e=>(e=e.replace(/\.tsx?$/g,"").replace(/\.mdx?$/g,"").replace(/^\/?index$/,"/").replace(/\/index$/,"").replace(/\[\.{3}.+\]/,"*").replace(/\((.+?)\)/g,"").replace(/\[(.+?)\]/g,":$1").replace(/\/\//g,"/"),/^\//.test(e)?e:"/"+e),It=e=>{const t={};for(const[n,r]of Object.entries(e)){const s=n.split("/"),o=s.pop(),a=s.join("/");t[a]||(t[a]={}),o&&(t[a][o]=r)}for(const[n,r]of Object.entries(t)){const s=Object.entries(r).sort(([o],[a])=>o[0]==="["&&a[0]!=="["?1:o[0]!=="["&&a[0]==="["?-1:o.localeCompare(a));t[n]=Object.fromEntries(s)}return t},jo=e=>Object.keys(e).sort((n,r)=>{const s=n.split("/").length,o=r.split("/").length;return s-o||r.localeCompare(n)}).map(n=>({[n]:e[n]})),Do=e=>{const t={};for(const r of Object.keys(e)){const s=r.split("/");s.pop();const o=s.join("/");t[o]||(t[o]=[]),t[o].includes(r)||t[o].push(r)}const n=Object.keys(t).sort((r,s)=>s.length-r.length);for(const r of n)for(const s of n)if(s.startsWith(r)&&s!==r){const o=new Set([...t[s],...t[r]]);t[s]=[...o]}return t},br="_404.tsx",Lo="_error.tsx",No=["GET","POST","PUT","DELETE","OPTIONS","PATCH"],To=e=>{const t=e.root,n=new RegExp(`^${t}`),r=y=>vn(y.replace(n,"")),s=new ht;s.use(async function(S,A){await gr.run(S,()=>A())});const o=e.NOT_FOUND,a=It(o),i=e.ERROR,l=It(i),u=e.RENDERER,d=Do(u),h=e.MIDDLEWARE,f=e.ROUTES,g=jo(It(f)),v=(y,S)=>{let A=S[y]??[];const C=R=>(A=S[R.join("/")],A||(R.pop(),R.length&&C(R)),A??[]),E=y.split("/");return A=C(E),A.sort((R,q)=>R.split("/").length-q.split("/").length),A},m={};for(const y of g)for(const[S,A]of Object.entries(y)){const C=new ht;let E=!1;const R=_o(S,a);R&&C.use(async(P,N)=>{if(await N(),P.res.status===404){const he=await R(P),J=new Response(he.body,{status:404,headers:he.headers});P.res=J}}),v(S,d).map(P=>{const N=u[P];N[de]&&(E=!0);const J=N.default;J&&C.all("*",J)});const V=Object.keys(h).find(P=>{const N=S.replaceAll("[","\\[").replaceAll("]","\\]").replaceAll("(","\\(").replaceAll(")","\\)");return new RegExp(N+"/_middleware.tsx?").test(P)});if(V){const P=h[V];P.default&&C.use(...P.default)}for(const[P,N]of Object.entries(A)){const he=N[de],J=Io(async function(se,xr){se.set(de,he?!0:E),await xr()}),re=N.default,fe=vn(P);re&&"fetch"in re&&(C.use(J),C.route(fe,re));for(const pe of No){const se=N[pe];se&&(C.on(pe,fe,J),C.on(pe,fe,...se))}re&&Array.isArray(re)&&(C.get(fe,J),C.get(fe,...re)),typeof re=="function"&&(C.get(fe,J),C.get(fe,async pe=>{const se=await re(pe);return se instanceof Response?se:pe.render(se,N)}))}const W=Mo(S,l);W&&(m[S]=W);for(const[P,N]of Object.entries(m))new RegExp(`^${P}`).test(S)&&N&&C.onError(N);let bt=r(S);s.route(bt,C)}for(const y of g.reverse()){const S=Object.entries(y)[0][0],A=new ht;$o(A,S,a);const C=r(S);s.route(C,A)}return s};function _o(e,t){for(const[n,r]of Object.entries(t))if(e===n){const s=r[br];if(s)return s.default}}function $o(e,t,n){for(const[r,s]of Object.entries(n))if(t===r){const o=s[br];if(o){const a=o.default;o[de]&&e.use("*",(l,u)=>(l.set(de,!0),u())),e.get("*",l=>(l.status(404),a(l)))}}}function Mo(e,t){for(const[n,r]of Object.entries(t))if(e===n){const s=r[Lo];if(s){const o=s.default;if(o)return async(i,l)=>{const u=s[de];return u&&l.set(de,u),l.status(500),o(i,l)}}}}const Wo=e=>To({root:"/app/routes",NOT_FOUND:Object.assign({"/app/routes/_404.tsx":Lr}),ERROR:Object.assign({"/app/routes/_error.tsx":Tr}),RENDERER:Object.assign({"/app/routes/_renderer.tsx":Es}),MIDDLEWARE:Object.assign({}),ROUTES:Object.assign({"/app/routes/index.tsx":no})}),Ho=({children:e})=>{const t=gr.getStore();if(!t)throw new Error("No context found");return p(je,{children:t.get(de)&&e})},Fo={"_honox-island-PK6lYULq.js":{file:"static/honox-island-PK6lYULq.js",name:"honox-island",imports:["app/client.ts"]},"_index-BJLlL6Rz.js":{file:"static/index-BJLlL6Rz.js",name:"index"},"app/client.ts":{file:"static/client-Cbyu1vri.js",name:"client",src:"app/client.ts",isEntry:!0,dynamicImports:["app/islands/CollapsibleSection.tsx","app/islands/DownloadSection.tsx","app/islands/SectionGroup.tsx","node_modules/honox/dist/client/runtime.js","node_modules/honox/dist/client/runtime.js"]},"app/islands/CollapsibleSection.tsx":{file:"static/CollapsibleSection-KAP09WCR.js",name:"CollapsibleSection",src:"app/islands/CollapsibleSection.tsx",isDynamicEntry:!0,imports:["app/client.ts","_honox-island-PK6lYULq.js","_index-BJLlL6Rz.js"]},"app/islands/DownloadSection.tsx":{file:"static/DownloadSection-CGH4UMh2.js",name:"DownloadSection",src:"app/islands/DownloadSection.tsx",isDynamicEntry:!0,imports:["app/client.ts","_honox-island-PK6lYULq.js"]},"app/islands/SectionGroup.tsx":{file:"static/SectionGroup-DivpzRO0.js",name:"SectionGroup",src:"app/islands/SectionGroup.tsx",isDynamicEntry:!0,imports:["app/client.ts","_honox-island-PK6lYULq.js","_index-BJLlL6Rz.js"]},"app/style.css":{file:"static/style-Dv8O0o5u.css",src:"app/style.css",isEntry:!0},"node_modules/honox/dist/client/runtime.js":{file:"static/runtime-Cy5uTkKR.js",name:"runtime",src:"node_modules/honox/dist/client/runtime.js",isDynamicEntry:!0,imports:["app/client.ts"]}},vr=Object.freeze(Object.defineProperty({__proto__:null,default:Fo},Symbol.toStringTag,{value:"Module"})),yr=e=>e.endsWith("/")?e:e+"/",Bo=e=>{const t=e.src;if(e.prod??!0){let n=e.manifest;if(!n){const r=Object.assign({"/dist/.vite/manifest.json":vr});for(const[,s]of Object.entries(r))if(s.default){n=s.default;break}}if(n){const r=n[t.replace(/^\//,"")];if(r)return p(Ho,{children:p("script",{type:"module",async:!!e.async,src:`${yr("/honox-resume/")}${r.file}`,nonce:e.nonce})})}return p(je,{})}else return p("script",{type:"module",async:!!e.async,src:t,nonce:e.nonce})},Go=e=>{let{href:t,prod:n,manifest:r,...s}=e;if(t)if(n??!0){if(!r){const o=Object.assign({"/dist/.vite/manifest.json":vr});for(const[,a]of Object.entries(o))if(a.default){r=a.default;break}}if(r){const o=r[t.replace(/^\//,"")];if(o)return t.startsWith("/")?p("link",{href:`${yr("/honox-resume/")}${o.file}`,...s}):p("link",{href:o.file,...s})}return p(je,{})}else return p("link",{href:t,...s});return p("link",{...s})},Sr=Wo();jr(Sr);const Ft=new ht,wr=Object.assign({"/app/server.ts":Sr});let Ar=!1;for(const[,e]of Object.entries(wr))e&&(Ft.all("*",t=>{let n;try{n=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,n)}),Ft.notFound(t=>{let n;try{n=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,n)}),Ar=!0);if(!Ar)throw new Error("Can't import modules from ['/src/index.ts','/src/index.tsx','/app/server.ts']");const Cr={},yn=new Set;for(const[e,t]of Object.entries(wr))for(const[n,r]of Object.entries(t))if(n!=="fetch"){if(yn.has(n))throw new Error(`Handler "${n}" is defined in multiple entry files. Please ensure each handler (except fetch) is defined only once.`);yn.add(n),Cr[n]=r}const Vo={...Cr,fetch:Ft.fetch};export{Vo as default};
