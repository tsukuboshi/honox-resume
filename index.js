...
\`\`\`txt
きちんとコードを読んで様々な問題に対応できるエンジニアになりたいという思いから、インフラのみならずサーバレスのアプリケーション開発経験も積極的に積んできました。  
...
\`\`\`txt
多くの人と技術の面白さについて語り合いという思いから、ブログ執筆や勉強会登壇、個人開発等のアウトプット活動に積極的に取り組んできました。   
DevelopersIO、Zennなどで200本以上の技術記事を執筆し、AWSや生成AIを中心とした最新技術を発信しています。
またJAWS-UGを主とした勉強会への登壇も20回以上実施surutotomoni 
、技術雑誌への寄稿実績もあります。  
\`\`\`
...
- TypeScript/Fastify/Prismaを用いたバックエンド開発
- Cloud Runを用いたコンテナデプロイ
- Alloy DBを用いたSQLオペレーション作業
...
- オンプレミスインフラの設計・構築
- コンテナ技術(Docker/Kubernetes)の検証・導入推進
